            ...
            <section className="bg-white dark:bg-gray-900">
                <div className="py-8 px-4 mx-auto">
                    <div className="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
                        <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Our Staff</h2>
                        <p className="font-light text-gray-500 lg:mb-16 sm:text-xl dark:text-gray-400">Our university's finest staff members are always happy to help you.</p>
                    </div>
                    <div className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
                        ...
                        <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <div className="p-5 w-full">
                                ...
                                <span className="text-gray-500 dark:text-gray-400">{staff.role} ({staff.department})</span>
                                <p className="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">{staff.description}</p>

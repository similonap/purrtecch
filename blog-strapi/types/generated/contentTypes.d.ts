...
export interface ApiCampusInfoCampusInfo extends Schema.CollectionType {
  collectionName: 'campus_infos';
  info: {
    singularName: 'campus-info';
    pluralName: 'campus-infos';
    displayName: 'CampusInfo';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiClassClass extends Schema.CollectionType {
  ...
  attributes: {
    ...
    staff_member: Attribute.Relation<
      'api::class.class',
      'manyToOne',
...
export interface ApiStaffMemberStaffMember extends Schema.CollectionType {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::campus-info.campus-info': ApiCampusInfoCampusInfo;
